...
private let logger = Logger(subsystem: "com.ic705.session", category: "UDPControl")
...
public final class UDPControl: UDPBase {
    ...
    public init(host: String, port: UInt16 = 50001, userName: String, password: String, computerName: String = "CLI") {
